...
```bash
uvx ogm-mcp-skills==0.1.9 --version
```
...
```json
{
  "mcp": {
    "ogm": {
      "type": "local",
      "command": ["uvx", "ogm-mcp-skills==0.1.9"],
      "environment": {
...
For source development, replace `uvx ogm-mcp-skills==0.1.9` with:
